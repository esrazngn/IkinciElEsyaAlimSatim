						...
						<tbody>
							<c:forEach var="urun" items="${urunler}">
								<tr>
									...
									<td><a
										href="${pageContext.request.contextPath}/person/edit/${person.username}.html">Edit</a><br />
										<a
										href="${pageContext.request.contextPath}/person/delete/${person.username}.html">Delete</a><br />
									</td>
								</tr>
							</c:forEach>
						</tbody>
